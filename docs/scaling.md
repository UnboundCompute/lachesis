...
the full-core libxml2 reference tree this measured 32.64 seconds cold at approximately
1.09 GB peak RSS with no swap. The previous 38.03-second run used the older streamed
frontend handoff. This is a timing reference, not a cache-warm result; the measurement
