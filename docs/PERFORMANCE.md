...
| 2026-08-21 | working tree | Linux `fs/netfs` streamed Kùzu with 25k-row batches | 6.11 | — | 1.15 | 13,185 | 24,719 | not sampled | Fresh disposable Python 3.11/Kùzu env, 1 GiB pool, tokens/proofs disabled. Raising the bounded Arrow batch from 10k to 25k cut Kùzu phases from 1.23s to 1.15s; header 0.112s, nodes 0.422s, edges 0.412s, indexes 0.108s. |
