...
def load_graph(path: str) -> tuple[dict, dict]:
    ...
    # A query must observe the same native binary dataflow sidecar as every other
    # surface. The removed Python enrichment fallback is intentionally not available.
